...
public class CheckRegistrazioneControllerT  extends AsyncTask<String, String, String> {
    public RegistrazioneActivityT frame;
    String z = null;


    public CheckRegistrazioneControllerT(RegistrazioneActivityT view) {
        frame = view;
    }
    ...
    protected String doInBackground(String... strings) {
        ...
        if (ConnectionClass.con == null) {
            ...
            if (frame.utente.checkEmail(String.valueOf(frame.email.getText())) && frame.utente.checkNickname(String.valueOf(frame.nickname.getText())) && frame.utente.checkUsername(String.valueOf(frame.username.getText()))) {
                ...
                Intent intent = new Intent(frame, MainActivityT.class);
